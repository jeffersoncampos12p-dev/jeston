...
| <Badge color="red" stroke icon="clock" />v1.1.0 | Older pre-2.x API and build contracts; no longer the compatibility target of the current source tree or release checks. | v2.1.x | Yes for active development. |
...
| <Badge color="red" stroke icon="exclamation-triangle" />v0.1.0 | First experimental release. It is retained only to explain the project's history and is not a supported runtime. | v2.1.x | Yes. |
