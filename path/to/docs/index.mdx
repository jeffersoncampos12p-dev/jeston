...
<Info>
**This page is a working surface, not a glossary.** It explains the framework surface, the runtime contract, and the path from a first route to a production platform. Use the examples as a review checklist: every boundary should have an owner, a failure mode, a measurable signal, and a rollback or recovery story.
</Info>

<Columns cols={2}>
  <Card title="Primary outcome" icon="rocket" type="check">
