...
| --- | --- |
| **Focus** | Coordinate ephemeral speed, durable work, and object lifecycle without confusing their guarantees. |
| **Deliverable** | Explicit freshness, retry, durability, ownership, and cleanup semantics. |
| **Reason to care** | Cache, queues, and storage solve different problems; combining their names does not combine their guarantees. |
