...
<Columns cols={3}>
  <Card title="Secure sessions" icon="user-lock" href="/platform/auth" horizontal>Read the focused guide for this boundary.</Card>
  <Card title="Harden HTTP" icon="globe" href="/reference/http-contracts" horizontal>Read the focused guide for this boundary.</Card>
  <Card title="Run securely" icon="server-stack" href="/operations/production" horizontal>Read the focused guide for this boundary.</Card>
</Columns>
