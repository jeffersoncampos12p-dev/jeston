...
| --- | --- |
| **Focus** | Separate proving who someone is from deciding what that person may do. |
| **Deliverable** | Signed sessions, secure cookies, authorization checks, rotation, and revocation behavior. |
| **Reason to care** | Authentication bugs become data-boundary bugs when identity and tenant scope are implicit. |
