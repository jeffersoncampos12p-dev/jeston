...
> **Reading lens** — Use this page to reason about login boundaries, signed sessions, cookies, authorization, rotation, and revocation. The goal is not to memorize APIs. The goal is to make a boundary explicit enough to implement, test, operate, and replace.

<Columns cols={2}>
  <Card title="What you will decide" icon="user-lock" type="check">
