...
<Columns cols={3}>
- [stream · **Stream agent work**](/core/execution-and-streaming) — Read the focused guide for this boundary.
- [shield-halved · **Protect tools**](/platform/security) — Read the focused guide for this boundary.
- [gauge-high · **Benchmark agents**](/operations/benchmark) — Read the focused guide for this boundary.
</Columns>
