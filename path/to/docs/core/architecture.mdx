...
<Columns cols={3}>
  <Card title="Trace route selection" icon="route" href="/core/routing" horizontal>Read the focused guide for this boundary.</Card>
  <Card title="Trace execution" icon="stream" href="/core/execution-and-streaming" horizontal>Read the focused guide for this boundary.</Card>
  <Card title="Design adapters" icon="puzzle-piece" href="/reference/adapters" horizontal>Read the focused guide for this boundary.</Card>
</Columns>
