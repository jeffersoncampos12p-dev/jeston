...
| --- | --- |
| **Focus** | See Jeston as a set of lifecycle contracts with replaceable platform edges. |
| **Deliverable** | A clear ownership map for compiler, router, request context, renderer, and adapters. |
| **Reason to care** | Architectural boundaries determine whether a heavy workload can be cancelled, measured, moved, or scaled. |
