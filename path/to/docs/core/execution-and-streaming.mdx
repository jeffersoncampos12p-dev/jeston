...
<Columns cols={3}>
- [power-off · **Drain long work**](/operations/jobs-and-shutdown) — Read the focused guide for this boundary.
- [brain · **Stream agent work**](/platform/ai-agents) — Read the focused guide for this boundary.
- [chart-line · **Measure streams**](/platform/health-observability) — Read the focused guide for this boundary.
</Columns>
