...
## Ryvax migration runner

Ryvax 2.0.0 includes a provider-neutral `createMigrationRunner` contract. Migration files use deterministic names such as `0001_users.up.sql` and `0001_users.down.sql`.
