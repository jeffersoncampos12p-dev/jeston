...
> **Reading lens** — Use this page to reason about schema evolution, compatibility windows, backfills, dual reads, and rollback plans. The goal is not to memorize APIs. The goal is to make a boundary explicit enough to implement, test, operate, and replace.

<Columns cols={2}>
  <Card title="What you will decide" icon="arrows-rotate" type="check">
