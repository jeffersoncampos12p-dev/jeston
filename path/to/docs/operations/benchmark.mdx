...
> **Reading lens** — Use this page to reason about workload design, percentiles, concurrency, saturation, memory, and honest comparisons. The goal is not to memorize APIs. The goal is to make a boundary explicit enough to implement, test, operate, and replace.

<Columns cols={2}>
  <Card title="What you will decide" icon="gauge-high" type="check">
