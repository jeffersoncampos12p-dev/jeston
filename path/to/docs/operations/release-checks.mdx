...
> **Reading lens** — Use this page to reason about tests, type checks, packaging, provenance, CI gates, and npm publication readiness. The goal is not to memorize APIs. The goal is to make a boundary explicit enough to implement, test, operate, and replace.

<Columns cols={2}>
  <Card title="What you will decide" icon="circle-check" type="check">
