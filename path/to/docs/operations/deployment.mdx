...
<Columns cols={3}>
  <Card title="Run the service" icon="server-stack" href="/operations/production" horizontal>Read the focused guide for this boundary.</Card>
  <Card title="Change schemas" icon="arrows-rotate" href="/operations/migrations" horizontal>Read the focused guide for this boundary.</Card>
  <Card title="Verify artifacts" icon="circle-check" href="/operations/release-checks" horizontal>Read the focused guide for this boundary.</Card>
</Columns>
