...
> **Reading lens** — Use this page to reason about integration quality, documentation, support expectations, compatibility policy, and community scale. The goal is not to memorize APIs. The goal is to make a boundary explicit enough to implement, test, operate, and replace.

<Columns cols={2}>
  <Card title="What you will decide" icon="sitemap" type="check">
