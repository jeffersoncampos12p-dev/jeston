...
<Accordion title="Detailed background for this page" icon="book-open">
  Make a new Ryvax workspace reproducible before writing application code.
...
> **Page focus** — Make a new Ryvax workspace reproducible before writing application code.
...
> **Purpose** — Make a new Ryvax workspace reproducible before writing application code.
...
| --- | --- |
| **Focus** | Make a new Ryvax workspace reproducible before writing application code. |
...
<Note>
  Do not add Vite, Express, or a second application runtime to the Ryvax setup.
</Note>
