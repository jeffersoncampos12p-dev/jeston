...
<Columns cols={3}>
  <Card title="Register integrations" icon="plug" href="/reference/integrations" horizontal>Read the focused guide for this boundary.</Card>
  <Card title="Apply a database adapter" icon="database" href="/platform/sql" horizontal>Read the focused guide for this boundary.</Card>
  <Card title="Review ownership" icon="diagram-project" href="/core/architecture" horizontal>Read the focused guide for this boundary.</Card>
</Columns>
