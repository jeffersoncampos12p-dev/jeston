...
<Columns cols={3}>
- [plug · **Register integrations**](/reference/integrations) — Read the focused guide for this boundary.
- [database · **Apply a database adapter**](/platform/sql) — Read the focused guide for this boundary.
- [diagram-project · **Review ownership**](/core/architecture) — Read the focused guide for this boundary.
</Columns>
