...
<Columns cols={3}>
  <Card title="Implement contracts" icon="brackets-curly" href="/core/api-routes" horizontal>Read the focused guide for this boundary.</Card>
  <Card title="Resolve paths" icon="route" href="/core/routing" horizontal>Read the focused guide for this boundary.</Card>
  <Card title="Secure responses" icon="shield-halved" href="/platform/security" horizontal>Read the focused guide for this boundary.</Card>
</Columns>
