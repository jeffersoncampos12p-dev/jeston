...
| --- | --- |
| **Focus** | Document the wire behavior that clients and intermediaries actually observe. |
| **Deliverable** | Predictable methods, status codes, headers, body rules, OPTIONS, HEAD, and malformed input responses. |
| **Reason to care** | HTTP details are compatibility surface; a small inconsistency can break caches, SDKs, proxies, or browser behavior. |
