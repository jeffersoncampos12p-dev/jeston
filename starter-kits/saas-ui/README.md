# Jeston SaaS UI Starter Kit

An open-source, production-minded SaaS dashboard starter built with [Jeston](https://github.com/jeffersoncampos12p-dev/jeston). It provides a responsive workspace shell, metrics, project tracking, activity feed, project detail pages, and JSON API routes that can be replaced with a database or authentication provider.
...
- Add authentication and authorization in Jeston middleware before exposing workspace data.
